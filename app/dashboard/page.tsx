      ...
      <div className="relative z-10">
        ...
        <main className="flex-1 container mx-auto px-4 pt-28 pb-16">
          ...
          >
            <div>
              <div className="flex items-center gap-3 mb-3">
                <div className="bg-blue-500/10 border border-blue-500/20 p-2.5 rounded-xl backdrop-blur-md">
                  <LayoutDashboard className="h-5 w-5 text-blue-400" />
                </div>
                <span className="text-xs font-bold uppercase tracking-widest text-blue-400">Console Operator</span>
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => router.push('/dashboard/settings')}
                  className="h-auto px-3 py-1.5 text-slate-400 hover:text-blue-400 hover:bg-blue-500/10 font-bold text-[10px] uppercase tracking-widest gap-2 rounded-xl border border-white/5 transition-all"
                >
              ...
              <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight leading-none mb-2">
                Dashboard <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Sekolah</span>
              </h1>
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-500 font-mono text-sm bg-slate-900/50 px-2 py-0.5 rounded-lg border border-white/5">NPSN: {npsn}</span>
              </div>
            </div>
            <div className="flex items-center gap-3 w-full md:w-auto">
              <Button
                ...
                className="flex-1 md:flex-none gap-2 border-white/10 bg-white/5 text-slate-300 hover:bg-red-500/10 hover:text-red-400 hover:border-red-500/20 transition-all rounded-xl h-12 px-6 backdrop-blur-sm"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            >
              <Card className="border border-white/5 shadow-2xl shadow-black/20 overflow-hidden rounded-[2.5rem] bg-white/5 backdrop-blur-xl">
                <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-8 gap-4 border-b border-white/5">
                  <div>
                    <CardTitle className="text-2xl font-black tracking-tight text-white">Konten Publikasi</CardTitle>
                        ...
                        {posts.map((post, index) => (
                          ...
                          >
                            <div className="flex items-center gap-5">
                              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110 ${post.category === 'pengumuman' ? 'bg-amber-50 text-amber-600' :
                              ...
                              <div>
                                <div className="flex items-center gap-3 mb-1">
                                  <span className={`text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded-lg ${post.category === 'pengumuman' ? 'bg-amber-100 text-amber-700' :
              ...
              <Card className="border border-white/5 shadow-2xl shadow-black/20 overflow-hidden rounded-[2.5rem] bg-white/5 backdrop-blur-xl">
                <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-8 gap-4 border-b border-white/5">
                  <div>
                    <CardTitle className="text-2xl font-black tracking-tight text-white">Pengiriman Berkas</CardTitle>
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                  <span className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded-md ${sub.status === 'verified' ? 'bg-green-100 text-green-700' :
                        ...
                        <>
                          <div className="space-y-4">
                            <div className="flex justify-between items-end">
                              ...
                              <span className={`px-2 py-1 rounded-lg text-[10px] font-bold uppercase ${Number(ratio) < 20 ? 'bg-green-50 text-green-600' : 'bg-amber-50 text-amber-600'
                                }`}>
              ...
              >
                ...
                <form onSubmit={handleSendSubmission} className="p-8 space-y-6">
                  <div className="space-y-4">
                    ...
                    <div
                      className={`border-2 border-dashed rounded-[2rem] p-10 text-center transition-all ${submissionFormData.file_url ? 'border-green-200 bg-green-50' : 'border-slate-200 hover:border-primary/30 hover:bg-slate-50'
                        }`}
                    >
                      {isUploadingFile ? (
        ...
        <AnimatePresence>
          {toast && (
            ...
            >
              <div className={`px-6 py-4 rounded-[2rem] shadow-2xl flex items-center gap-4 border-2 ${toast.type === 'success' ? 'bg-white border-green-100 text-slate-900' : 'bg-white border-red-100 text-slate-900'
                }`}>
                {toast.type === 'success' ? (
